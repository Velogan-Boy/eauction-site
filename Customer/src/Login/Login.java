...
public class Login extends JFrame {
	...
	public Login() throws UnknownHostException, IOException {
		...
		icon2=new ImageIcon("../ProjectImages2/login.jpg");
		...
		lblNewLabel.setIcon(new ImageIcon("../ProjectImages2/Login2.png"));
		...
		lblNewLabel_1.setIcon(new ImageIcon("../ProjectImages2/User5.png"));
		...
		label = new JLabel("");
		label.setIcon(new ImageIcon("../ProjectImages2/pwd3.png"));
